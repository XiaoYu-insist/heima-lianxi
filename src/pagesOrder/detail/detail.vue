...
import { ref } from 'vue'
import pageSkeleton from './components/pagesSkeleton.vue'
  ...
  uni.showModal({
    ...
    success: async (success) => {
      if (success.confirm) {
        ...
        uni.showToast({ title: '完成收货！', icon: 'none' })
        order.value = res.result
      }
    },
  })
  ...
  <uni-popup ref="popup" type="bottom" background-color="#fff">
    <view class="popup-root">
      ...
      <view class="footer">
        ...
        <view class="button primary" @tap="onOrderClose">确认</view>
      </view>
    </view>
  </uni-popup>
</template>
