...
// 分类列表API
const categoryTypes = ref<CategoryTopItem[]>([])
const getCategoryData = async () => {
  const res = await getCategoryAPI()
  categoryTypes.value = res.result
}

const subCategoryList = computed(() => {
  return categoryTypes.value[activeIndex.value]?.children || []
})
//骨架加载
...
<template>
  <view class="viewport" v-if="Skeleton">
    <!-- 搜索框 -->
    <view class="search">
      <view class="input">
